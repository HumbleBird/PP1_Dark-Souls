...
public class StatusUI : UI_Popup
{
    ...
    public override bool Init()
    {
        ...
        // Right - Resistances / Armor
        GetText((int)Texts.BleedResistancesArmorValueText).text = string.Format("{0, 0} / {1, 52}", player.playerStatsManager.m_fBleedResistance, player.playerStatsManager.m_fBleedArmor); // 캐릭터 스텟 저항, 값옷
