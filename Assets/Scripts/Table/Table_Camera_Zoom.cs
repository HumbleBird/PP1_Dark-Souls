...
public class Table_Camera_Zoom : Table_Base
{
    [Serializable] 
    public class Info
    {
        ...
        public float m_fDest            ;
        public float m_fBlendInTime         ;
        public float m_fDuration            ;
        public float m_fBlendOutTime            ;
    }
    ...
    protected bool Read(CSVReader _reader, Info _info, int _nRow, int _nStartCol)
    {
        ...
        _reader.get(_nRow, ref _info.m_fDest         );
        _reader.get(_nRow, ref _info.m_fBlendInTime  );
        _reader.get(_nRow, ref _info.m_fDuration     );
        _reader.get(_nRow, ref _info.m_fBlendOutTime );
