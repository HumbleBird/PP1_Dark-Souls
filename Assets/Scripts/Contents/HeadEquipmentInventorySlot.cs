...
public class HeadEquipmentInventorySlot : MonoBehaviour
{
    ...
    public void EquipThisItem()
    {
        if (uiManager.headEquipmentSlotSelected)
        {
            ...
            uiManager.player.playerInventoryManager.headEquipmentInventory.Remove((HelmEquipmentItem)item);
        ...
        uiManager.m_PlayerPrivateUI.m_EquipmentUI.LoadArmorOnEquipmentScreen(uiManager.player.playerInventoryManager);
